package com.example.springboardpractice.controller;
...
class ArticleControllerTest {
    ...
    @Test
    public void givenNothing_whenRequestingArticleHashtagView_thenReturnsArticlesHashtagView() throws Exception {
